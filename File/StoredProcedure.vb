...
Public Class StoredProcedure
    ...
    Public Sub generateFile() Implements Writable.generateFile
        ...
        PrintLine(libre, TAB(4), "Public Overloads Function Select_Record(" & strKey & ", Optional ByRef trans As System.Data.SqlClient.SqlTransaction = Nothing) As DBO_" & clase)
        ...
        PrintLine(libre, TAB(8), "MyBase.Select_Record(ctype(dbo, BasesParaCompatibilidad.Databussines), trans)")
        PrintLine(libre, TAB(8), "Return dbo")
        PrintLine(libre, TAB(4), "End Function")
        PrintLine(libre, "")

        PrintLine(libre, TAB(4), "Public Overrides Function Delete(" & strKey & ", Optional ByRef trans As System.Data.SqlClient.SqlTransaction = Nothing) As Boolean")
        PrintLine(libre, TAB(8), "Dim dbo As New DBO_" & clase)
        PrintLine(libre, TAB(8), "dbo.searchKey = dbo.item(""" & reg.nombre & """)")
        PrintLine(libre, TAB(8), "dbo.searchKey.value = " & reg.nombre)
        PrintLine(libre, TAB(8), "return MyBase.DeleteProcedure(ctype(dbo, BasesParaCompatibilidad.Databussines), trans)")
        PrintLine(libre, TAB(4), "End Function")
        PrintLine(libre, "")
